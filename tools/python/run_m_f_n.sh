...
echo "Single-task learning NOT MNIST"
python2 cnn_single.py --is_not_mnist --learning_rate=.001 --fresh --epoch=25
python2 cnn_single.py --is_not_mnist --learning_rate=.00001 --epoch=25
